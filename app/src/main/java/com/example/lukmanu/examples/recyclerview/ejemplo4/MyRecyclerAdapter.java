...
public class MyRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        if (viewType == TYPE_PROFESOR)
            return new MyViewHolderProfesor(LayoutInflater.from(parent.getContext()).inflate(R.layout.listview_2_item_with_background, parent, false));
        else
            return new MyViewHolderPersona(LayoutInflater.from(parent.getContext()).inflate(R.layout.listview_item_with_background, parent, false));
    }
